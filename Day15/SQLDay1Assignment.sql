...
INSERT INTO DEPARTMENT (deptname, DeptFloor, phone, empno)
VALUES
    ('Management', 5, '34', 1),
    ('Books', 1, '81', 4),
    ('Clothes', 2, '24', 4),
...
-- Adding foreign key constraints to EMP table
ALTER TABLE EMP
...
-- Adding foreign key constraint to DEPARTMENT table
ALTER TABLE DEPARTMENT
ADD CONSTRAINT FK_DEPT_Emp FOREIGN KEY (empno) REFERENCES EMP(empno);

-- Adding foreign key constraints to SALES table
ALTER TABLE SALES
